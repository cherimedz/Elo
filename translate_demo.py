...
st.markdown("<label style='font-size: 18px;'>Enter the text you want to translate:</label>", unsafe_allow_html=True)
...
st.markdown("<label style='font-size: 18px;'>Select the target language:</label>", unsafe_allow_html=True)
